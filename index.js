...
let pokemon1img = document.querySelector(".pokemon-1__img");
let pokemon1hp = document.querySelector(".pokemon-1__hp");
let pokemon1name = document.querySelector(".pokemon-1__name");
let pokemon1attack = document.querySelector(".pokemon-1__attack");
let pokemon1defense = document.querySelector(".pokemon-1__defense");
let pokemon1type = document.querySelector(".pokemon-1__type");
// Selectores para el Pokemon 2
let pokemon2img = document.querySelector(".pokemon-2__img");
let pokemon2hp = document.querySelector(".pokemon-2__hp");
let pokemon2name = document.querySelector(".pokemon-2__name");
let pokemon2attack = document.querySelector(".pokemon-2__attack");
let pokemon2defense = document.querySelector(".pokemon-2__defense");
let pokemon2type = document.querySelector(".pokemon-2__type");
...
// 🤓 Pista: Para enfrentar 2 pokemones aleatores, necesitamos hacer 2 llamados a la API con 2 números aleatorios entre el 1 y el 900
...
const obtenerNumeroAlAzar = (nMin, nMax) => {
  return Math.floor(Math.random() * (nMax - nMin + 1) + nMin);
}

let pokemonID1 = obtenerNumeroAlAzar(1, 900);
let pokemonID2 = obtenerNumeroAlAzar(1, 900);
...
const traerPokemon = async (pokeID) => {
